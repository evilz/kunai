...
public static class TextExtensions
{
	...
	public static string AsJoinedString<T>(this IEnumerable<T> enumerable, string separator = " ") => string.Join(separator, enumerable);
	...
	public static string NullToEmpty(this string input) => input ?? string.Empty;
